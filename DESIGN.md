...
- **Nodes**: the written core concepts (currently about eighteen, including geras–time, themis–dike, oiktos–eleos pairs) plus Achilles and Odysseus. Fixed flowchart/SVG map, not a force graph.
