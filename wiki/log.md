...
- **정리 대상**: Git에서 제외된 `scratch/` 임시 작업 디렉터리의 6,107개 파일과 약 332 MiB를 제거함.
- **보존 범위**: Git 추적 파일과 `raw/` 원본은 수정하거나 삭제하지 않음.
- **재생성 가능성**: 제거한 Quartz 복제본, 의존성, 빌드·시각 검수 산출물은 고정된 Quartz 커밋과 프로젝트 빌드 절차를 통해 필요할 때 다시 생성할 수 있음.
