---
title: 개념명 (관용 라틴명)
aliases: [라틴문자명, 희랍어명, 대안표기]
tags: [type/concept, domain/iliad, domain/odyssey, domain/culture, domain/etymology, status/draft]
created: YYYY-MM-DD
updated: YYYY-MM-DD
sources: []
status: draft
...
concept_domain: ethical # ethical | institutional | psychological | theological | cosmic
polar_opposites: ["[[concept-관련개념|대립개념]]"]
embodying_entities: ["[[entity-관련인물|체현인물]]"]
---
...
flowchart TD
    ...
    Institution --> Sanction["초월적 신벌 또는 보상"]
```
