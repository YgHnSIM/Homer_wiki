...
- 호메로스 텍스트에서 엘레오스는 인간 관찰자뿐만 아니라 **올림포스 신들의 행동을 규정하는 핵심 어휘**입니다.
  1. **올림포스 신들의 구호 개입**: 『오뒷세이아』 1권 19–21행에서 모든 신이 오디세우스를 불쌍히 여겨 구호하려 한 충동(*eleairon*)과, 홀로 지속된 포세이돈의 파괴적 분노(*meneainen*)의 대립은 엘레오스가 메노스(Menos)의 맹위를 제어하는 도덕적 대척점임을 보여줍니다.
...
- **서사시의 클라이맥스: 24 권 화해와 실천적 구호**:
  ...
  - 함께 눈물을 흘리며 슬픔의 갈망(*hímeron góoio*)을 해소한 뒤, 아킬레우스는 오익토스로 노인을 일으켜 세운 것에 그치지 않고, 헥토르의 시신을 손수 씻겨 인도하고 12일간의 장례 휴전을 보장하는 완전한 엘레오스의 실천을 완성합니다.
...
```mermaid
flowchart TD
    subgraph PolarConflict ["(1) 파괴적 대립 충동"]
        WAR["전장 경쟁 논리<br/>(Nelees / 무자비)"]
        MEN["메니스 (Menis) 및 메노스 (Menos)<br/>파괴적 복수열"]
        HYB["휘브리스 (Hybris)<br/>오만한 승자의 시신 유린"]
    end

    subgraph GroundStage ["(2) 비경쟁적 지반 형성"]
        HIK["히케시아 (Hikesia)<br/>신성 탄원 의례"]
        XEN["크세니아 (Xenia)<br/>손님 환대와 필로테스"]
        MORT["공통의 필멸성 자각<br/>(Condicio humana)"]
    end

    subgraph InternalInhibition ["(3) 심리적 관문"]
        PH["프렌 (Phren)<br/>가치 숙고 및 일시정지"]
        OIK["오익토스 (Oiktos)<br/>감정적 억제 및 가해 자제"]
    end

    subgraph PositiveDrive ["(4) 엘레오스 구호 추진력"]
        ELE["엘레오스 (Eleos)<br/>적극적 구호 추진력 (Forward Drive)"]
    end

    subgraph RestorativeAction ["(5) 실천적 귀결"]
        ACT1["시신 정화 및 인도<br/>(헥토르 시신 반환)"]
        ACT2["공동 식사 대접<br/>(니오베 설화 인용)"]
        ACT3["12일 장례 휴전 보장"]
        SAN["신들의 네메시스 (Nemesis) 회피<br/>우주적 균형 회복"]
    end

    WAR & MEN & HYB -.->|"엘레오스 발동 차단"| ELE

    HIK & XEN & MORT --> GroundStage
    GroundStage --> PH
    PH --> OIK
    OIK -->|"억제 거쳐 구호로 이행"| ELE
...
- **본문 강독 및 해제**:
  ...
  - **원문**: ἀλλ᾽ αἰδεῖο θεούς, Ἀχιλεῦ, αὐτόν τ᾽ ἐλέησον / μνησάμενος σοῦ πατρός· ἐγὼ δ᾽ ἐλεεινότερός περ, / ἔτλην δ᾽ οἷ᾽ οὔ πώ τις ἐπιχθόνιος βροτὸς ἄλος, / ἀνδρὸς παιδοφόνοιο ποτὶ στόμα χεῖρ᾽ ὀρέγεσθαι.
...
### 5.2 전장에서의 무자비(Nelees)와 뤼카온 탄원 거절 (_Il._ 21.74–76, 106–110)

- **문헌학적·서사학적 함의**:
...
- **본문 강독 및 해제**:
  - **번역**: "무릎 꿇고 간청합니다, 오디세우스여! 나를 존중하시고 나를 불쌍히 여겨주소서. 신들과 인간들에게 노래하는 가객인 나를 죽인다면, 훗날 당신 자신에게도 비탄이 될 것입니다. 나는 독학으로 깨우쳤으며, 신께서 내 마음에 온갖 노래의 길들을 심어주셨습니다. ... 멈추십시오! 이 죄 없는 자를 청동 칼로 치지 마십시오."
  - **원문**: γουνοῦμαί σ᾽, Ὀδυσεῦ· σὺ δέ μ᾽ αἴδεο καί μ᾽ ἐλέησον· / αὐτῷ τοι μετόπισθ᾽ ἄχος ἔσσεται, εἴ κεν ἀοιδὸν / πέφνῃς, ὅς τε θεοῖσι καὶ ἀνθρώποισιν ἀείδω. / αὐτοδίδακτος δ᾽ εἰμί, θεὸς δέ μοι ἐν φρεσὶν οἴμας / παντοίας ἐνέφυσεν· ... / ἴσχεο μηδέ τι τοῦτον ἀναίτιον οὔταε χαλκῷ·
  - **학술 전사**: *gounoûmaí s’, Oduseû; sù dé m’ aídeo kaí m’ eléēson; / autō̂i toi metópisth’ ákhos éssetai, eí ken aoidòn / péphnēis, hós te theoîsi kaì anthrṓpoisin aeídō. / autodídaktos d’ eimí, theòs dé moi en phresìn oímas / pantoías enéphusen; ... / ískheo mēdé ti toûton anaítion oútae khalkō̂i;*
- **문헌학적·서사학적 함의**:
...
### 6.1 포로 처우와 몸값(Apoina)의 경제학
- **살려줌(Zōgrein)의 상업적 논리**: 고졸기 전쟁 관행에서 적의 자비 탄원을 수락하는 것은 철저한 경제적 거래였습니다. 패자는 부유한 오이코스의 청동, 금, 철 등 막대한 몸값([[concept-apoina|Apoina]])을 제공함으로써 목숨을 건졌습니다 (_Il._ 6.46–50).
- **무자비(Nēleēs)로의 급변**: 그러나 전우의 죽음이나 씨족 간 혈원 복수의 계기가 발생할 때, 몸값의 경제학은 즉각 붕괴하고 절대적 무자비(*nēleēs*)가 지배합니다. 엘레오스는 복수의 쾌락보다 물질적 보상이 클 때에만 한시적으로 허용되는 조건부 제도 장치였습니다.

### 6.2 오이코스 외부 무권리자와 크세니아의 비대칭적 확장
- **무권리자의 생존 안전망**: 오이코스의 보호를 상실한 부랑 걸인, 살인 망명자, 전쟁 포로는 사법적 권리가 전무한 아티모스([[concept-time|Atimos]])로 전락합니다.
- **비대칭적 환대의 동기**: 대등한 귀족 간의 손님 환대([[concept-xenia|Xenia]])가 상호적 답례를 전제한다면, 보답할 재화가 전무한 극빈자에게 음식을 나누어주게 만드는 규범적 동기는 바로 엘레오스였습니다 (_Od._ 17.367).
...
- 『일리아스』 24권에서 프리아모스와 아킬레우스가 함께 쏟아내는 눈물(Goos)은 추상적 감상이 아니라, 가슴속을 채우고 있던 파괴적 격분([[concept-cholos|Cholos]])을 물리적으로 탈진시켜 씻어내는 정화(Katharsis)의 생리적 과정이었습니다.
...
- 양을 잡고 빵과 고기를 나누는 공동 식사(Syssitia)는 살인자와 피해자 유족 사이의 적대적 긴장을 일시 해체하고, 생존을 위해 음식을 취해야만 하는 '가련한 필멸자'라는 신체적 지평에서 두 사람을 결속시킵니다.

### 7.3 시신 정화와 직물의 물질문화
- 아킬레우스는 하녀들에게 명하여 헥토르의 시신을 깨끗한 물로 씻기고 올리브 기름을 바르게 한 뒤, 아름다운 겉옷(pharos)과 정교한 튜닉(chitōn)으로 정중히 감싸 안치하도록 지시합니다 (_Il._ 24.582–590). 물, 향유, 고급 직물은 엘레오스가 파괴된 육신의 존엄을 물질을 통해 복원하는 구체적 실천임을 보여줍니다.
...
- 올림포스의 신들은 지상의 살육전을 안전한 관객석에서 감상하는 '신적 관객'입니다 ([[lee-taesoo-2020-gods-in-audience|이태수 2020]]). 신들의 연민은 무대 위 비극을 보며 흘리는 일시적이고 안전한 '심미적 연민(Aesthetic Pity)'에 불과하며, 신들은 자신의 불멸성을 담보로 인간의 고통에 뛰어들지 않습니다.
- 반면 인간 영웅 아킬레우스가 자신의 요절 운명을 직시하며 프리아모스에게 베푸는 엘레오스는, 자신의 취약성을 온전히 짊어지는 숭고한 실존적 결단입니다.

### 8.2 시신 훼손(Aikia)의 금기와 죽은 자의 몫(Geras Thanonton)
- 전사자의 시신을 유린하는 행위(아이키아, *aeikía*)는 올림포스 신들의 신적 의분([[concept-nemesis|Nemesis]])을 촉발하는 종교적 금기입니다. 
- 정당한 매장 의례(Kedeia)는 필멸자가 현세에서 거둘 수 있는 마지막 명예인 '죽은 자들의 몫(*géras thanóntōn*)'이며, 신들은 아킬레우스에게 엘레오스를 회복할 것을 강제함으로써 우주적 균형을 수호합니다.
...
### 9.1 감정좌소에서의 생리적 전환
- **튀모스(Thumos) 냉각**: 적을 향해 돌진하는 맹렬한 살의(메네아이네인)로 들끓던 튀모스는 비경쟁적 지반 위에서 열기가 부드럽게 냉각되는 과정(*thumòn iaínein*)을 거칩니다.
...
- 아무리 위대한 아가토스라도 불행과 상실을 피할 수 없다는 냉혹한 세계 질서를 직시함으로써, 아킬레우스는 맹목적 분노(**메니스**)를 거두고 동료 인간을 가엾게 여기는 실존적 연민(**엘레오스**)에 도달합니다.
...
- 아리스토텔레스는 『시학』(*Poetics* 13장, 1453a)에서 비극의 목적을 공포(포보스)와 연민(엘레오스)을 통한 감정의 정화(**카타르시스**, *katharsis*)로 정초했습니다.
- 호메로스의 성공 붕괴에 대한 비애감이 아리스토텔레스에 이르러 '부당하게 불행을 겪는 자(*anaxion dystychounta*)'라는 명시적인 '도덕적 자격 규범'으로 개념사적 진화를 이룩했습니다.
...
| **선희랍 기층어 기원과 무자비(Nelees)**: 엘레오스는 기층어/탄식 기원이며 부정형 νηλεής는 전장의 무자비를 규정함. | Chantraine DELG 339; Beekes EDG 407–408 | 비교언어학 | 강한 학술 추론 | 2절, 3절 |
