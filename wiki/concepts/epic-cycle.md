...
## 2. 트로이 서사시환의 연대기 구조 (8편)

트로이 서사시환은 사건의 발생 순서에 따라 다음과 같은 8편의 육보격(Dactylic Hexameter) 서사시로 구성됩니다:

```mermaid
flowchart TD
    C["1. 퀴프리아 (Cypria, 11권, 실전)<br/>불화의 사과, 헬레네 납치, 아울리스 집결, 스퀴로스 은신, 9년간의 원정 발단"] --> I["2. 일리아스 (Iliad, 24권, 호메로스 현존)<br/>아킬레우스의 분노(Mênis), 헥토르 사살, 프리아모스와의 연민과 화해"]
    I --> A["3. 아이티오피스 (Aethiopis, 5권, 실전)<br/>아마존 펜테실레이아·멤논 참전, 아킬레우스의 전사와 장례식"]
    A --> L["4. 소일리아스 (Little Iliad, 4권, 실전)<br/>아킬레우스 무구 재판, 아이아스 자살, 네오프톨레모스 참전, 목마 제작"]
    L --> P["5. 일리오스의 파괴 (Ilioupersis, 2권, 실전)<br/>트로이 목마 침투, 트로이 함락과 약탈, 폴뤽세네 희생 제물"]
    P --> N["6. 귀환 (Nostoi, 5권, 실전)<br/>그리스 장수들의 귀향과 조난, 아가멤논 암살, 아킬레우스 망령의 경고"]
    N --> O["7. 오뒷세이아 (Odyssey, 24권, 호메로스 현존)<br/>오디세우스의 10년 표류, 저승(Nekuia) 영웅 대면, 구혼자 처단과 평화"]
    O --> T["8. 텔레고네이아 (Telegony, 2권, 실전)<br/>키르케의 아들 텔레고노스의 내방, 오디세우스의 비극적 죽음과 영웅시대 종결"]
```
...
- **주요 내용**:
  ...
  - 파리스의 헬레네 납치와 스파르타 침탈, [[아가멤논]]과 메넬라오스의 그리스 전역 동원령.
  - [[achilles | 아킬레우스]]의 참전을 막기 위한 테티스의 스퀴로스섬 여장 은신, 데이다메이아와의 사이에서 [[네오프톨레모스]] 출생, [[오디세우스]]의 간계에 의한 징집.
...
- 트로이 전쟁 10년째, 아가멤논과의 불화로 인한 [[achilles | 아킬레우스]]의 신적 분노([[Menis]])와 전선 이탈.
- [[파트로클로스]]의 출전과 [[헥토르]]에 의한 전사, 아킬레우스의 복수 복귀와 헥토르 사살.
- 프리아모스 왕의 야간 탄원([[Hikesia]]) 수용, 두 항아리 우화와 인간 조건에 대한 비극적 연민([[Eleos]]), 헥토르 장례식으로 종결.
...
- **주요 내용**:
  ...
  - [[아이아스]]와 [[오디세우스]]의 격렬한 유해 구출 작전, 테티스와 무사이들의 애가, 아킬레우스의 유골을 파트로클로스의 유골과 황금 항아리에 합장. 테티스가 아들을 흑해의 백도(레우케섬)로 데려가 불멸화했다는 전승 수록.

### 3.4 『소일리아스』 (Little Iliad / Ἰλιὰς μικρά, 4권) — 실전
- **추정 작가**: 피라의 레스케스(Lesches).
- **주요 내용**:
  - 아킬레우스의 헤파이토스제 신성 무구를 둘러싼 [[오디세우스]]와 [[아이아스]]의 재판. 아테나의 개입으로 오디세우스 승리.
  - 패배한 아이아스의 광기(가축 도살)와 수치심에 의한 자살.
  - 예언자 헬레노스 생포 및 트로이 함락 조건 획득(헤라클레스의 활, 팔라디온 탈취, 펠롭스의 유골, [[네오프톨레모스]] 참전).
...
- **주요 내용**:
  ...
  - 트로이 성채의 함락과 대약탈. [[네오프톨레모스]]가 제우스 헤르케이오스 제단에서 프리아모스 왕을 도륙.
...
- 호메로스의 두 작품을 제외한 6편의 서사시환 텍스트는 고대 말기-비잔티움 초기에 소실되었습니다.
- 현대 고전학이 서사시환의 줄거리를 복원할 수 있는 것은 9세기 비잔티움 총대주교 **포티오스(Photios)**의 『비블리오테케』(Bibliotheke, codex 239)에 인용되어 전하는 **프로클로스(Proclus)**의 저작 **『문학 요람』(Chrestomathia)** 요약문 덕분입니다.
  > [!NOTE] 프로클로스 저자 문제
...
- **신분석파(Neo-analysis)의 평가**: 20세기 고전문헌학 연구(Kullmann, Burgess 등)는 서사시환이 단순한 호메로스 모방작이 아니라, 호메로스 이전부터 구비 전승되던 다채로운 영웅 신화의 원형적 모티프들을 보존하고 있는 귀중한 지식의 보고로 재평가합니다.

### 4.2 아리스토텔레스 『시학』에서의 비판
아리스토텔레스는 『시학』(Poetics, 1459a–b)에서 호메로스와 서사시환 시인들의 극적 구성력을 다음과 같이 대비하며 호메로스의 탁월성을 찬양했습니다:
...
- **서사시환의 연대기적 나열**: 반면 『퀴프리아』나 『소일리아스』의 작가들은 한 인물이나 한 시대의 모든 사건을 연대기순으로 산만하게 나열했기 때문에, 『소일리아스』 하나에서만 무구 재판, 필록테테스, 네오프톨레모스, 목마, 함락 등 8편 이상의 비극 소재가 난립하게 되었다.
...
- [[achilles]] — 아킬레우스 엔티티 문서 (서사시환 전승 수록)
- [[Menis]] — 일리아스의 핵심 모티프 (신적 분노)
- [[Nostos]] — 귀환 모티프와 오뒷세이아
- [[Themis]] — 신성 관습과 영웅 사회 규범
- [[Aidos]] — 수치심과 경외
