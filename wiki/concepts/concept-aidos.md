...
**아이도스(Aidôs, αἰδώς)**는 호메로스 서사시와 고대 그리스 문화 전반을 관통하는 가장 핵심적인 도덕 감정으로, **타인의 시선, 공적 평판, 사회적 규범 또는 신적 권위 앞에서 느끼는 경외(Reverence), 존경(Respect), 수치심(Shame), 자기억제(Inhibition)**를 포괄하는 종합적 심리 기제입니다.
...
```mermaid
graph TD
    A["아이도스 (Aidôs)<br/>시선과 규범 앞에서의 '감정적 위축 및 억제'"] --> B["(1) 전장의 무용과 전우애<br/>비겁 낙인 회피, 전열 유지, 명예(Timê) 수호"]
    A --> C["(2) 위계 질서와 권력 존중<br/>군주, 노인, 부모에 대한 공경과 경외"]
