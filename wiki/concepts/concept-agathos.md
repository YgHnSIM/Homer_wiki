...
### 1.1 결과주의적 규범과 오이코스 보전의 필연성 (Adkins 1960)

아서 애드킨스(A. W. H. Adkins)는 『공적과 책임』(*Merit and Responsibility*, 1960) 제2장과 제3장을 통해 호메로스 사회의 아가토스 개념을 지탱하는 사회구조적·도덕심리학적 필연성을 규명했습니다:

1. **중앙 공권력 부재 하의 오이코스(Oikos) 보전 (제3장)**:
   - 호메로스 시대에는 법원, 성문화된 법률, 치안 경찰과 같은 중앙 집중적 사법 기구가 전무했습니다.
   - 이러한 무정부적 원시 귀족 사회에서 한 가문([[concept-oikos|Oikos]])의 존속과 토지, 가축, 그리고 처자식과 노예의 안전은 오직 가문의 수장인 아가토스의 물리적 무력과 전투적 억지력에 의해서만 보장되었습니다.
   - 아가토스가 전장에서 무력함을 드러내거나 패배하는 순간, 가문 전체가 도륙당하거나 부녀자들이 적국의 노예로 전락하는 파멸적 결과를 맞이합니다. 따라서 전사적 탁월성과 승리라는 '결과주의적 성공'은 귀족의 사치스런 선택이 아니라 가문 생존을 위한 절대적 사회적 필연성이었습니다.
2. **자유의지와 강제: 신들의 원인 작용과 모이라(Moira)의 귀결 (제2장)**:
   - 애드킨스는 호메로스 가치 체계에서 행위자가 외적 강제(*anankē*)를 당했거나, 신들의 개입([[concept-ate|Atē]]) 또는 정해진 운명([[concept-moira|Moira]])에 의해 불가항력적으로 패배했더라도 근대적 의미의 '도덕적 면책(Moral exculpation)'이 성립하지 않는다고 분석합니다.
   - 행위자가 "최선을 다했으나 운명이 가혹했다"거나 "신이 마음을 빼앗았다"고 변명할 수는 있지만, 그 변명이 전장에서의 실패 자체를 지워주지는 못합니다. 실패한 자는 변명의 여지 없이 즉각 비난어인 **카코스**([[concept-kakos|Kakos]], κακός / 무능하고 비천한 자)로 전락하며 사회적 경멸(*aischron*)을 감내해야 했습니다. 호메로스적 평가는 내면의 의도(Intention)가 아니라 철저히 외부적 결과(Results)에 의해서만 결정되었기 때문입니다.

### 1.2 학설 대립: 결과주의 모델 대 적절성의 기준 및 상호 탁월성 추구

애드킨스의 이러한 도식적 결과주의 모델은 이후 고전학계에서 격렬한 비판과 생산적 논쟁을 촉발했습니다:

- **A. A. 롱의 '적절성의 기준' 비판** ([[long-1970-morals-and-values|Long 1970]]):
  - A. A. 롱은 애드킨스가 고대 텍스트에 칸트주의적 '도덕적 의무' 편견을 투사하여 호메로스 가치를 '경쟁적 가치'와 '협력적 가치'로 무리하게 2분화했다고 비판했습니다.
  - 롱에 따르면 호메로스 영웅 윤리의 핵심은 2분법적 가치 서열이 아니라, 행위자가 자신의 신분과 구체적 맥락에 합당하게 행동하는 ‘**적절성의 기준(Standard of Appropriateness)**’과 운명의 몫([[concept-moira|Kata moiran]])을 넘어서지 않는 자기 절제에 있었습니다. 즉 아가토스는 맹목적 힘의 승리자가 아니라 맥락에 걸맞은 품위를 지닌 자였습니다.
- **마르갈리트 핀켈버그의 '상호 탁월성 추구' 비판** ([[finkelberg-1998-time-and-arete|Finkelberg 1998]]):
  - 핀켈버그는 애드킨스의 단순 성공 결과주의를 논파하며, 호메로스 영웅들의 경쟁(*agōn*)이 물질적 승패의 결과주의가 아니라 **동등자 간의 상호 탁월성 추구**(Mutual emulation of equals)를 통해 도달하는 '탁월성의 정점'(*ákron aretês*)이었음을 밝혔습니다.
  - 『일리아스』 11.408–410에서 오디세우스가 독백하듯, 비천한 자(*kakoi*)만이 싸움을 피하며, 진정한 아가토스는 결과적 승리가 불확실하더라도 전열 맨 앞에 서서 위험을 감수하는 **실천적 행위(Enérgeia)** 그 자체를 통해 입증됩니다.
- 알래스데어 매킨타이어의 ‘**역할에 정초된 덕**’ ([[macintyre-1981-after-virtue-ch10|MacIntyre 1981]]):
  - 매킨타이어는 아가토스가 추상적 도덕 규범이 아니라 군주, 장수, 전사라는 구체적 사회적 역할(Role)을 완벽히 수행하는 기능적 탁월성임을 확인했습니다.
...
### 4.3 아가토스의 위계와 결과의 충돌: 에우멜로스 vs 안틸로코스의 전차 경주 논쟁 (『일리아스』 23권)

파트로클로스 장례 경기 전차 경주(23.535–615)는 애드킨스([[adkins-1960-merit-and-responsibility|Adkins 1960]], 제3장, pp. 52–55)가 호메로스 가치 체계 내에서 '신분적 탁월성'과 '결과주의적 성공'이 빚어내는 첨예한 긴장을 입증하기 위해 집중 분석한 결정적 에피소드입니다:

1. **아킬레우스의 '설득적 정의' 제안**:
   - 경기 전부터 가장 뛰어난 전차병으로 공인받았던 에우멜로스는 아테나 신의 개입으로 마차 멍에가 부러지는 불운을 겪으며 꼴찌로 결승선을 통과합니다.
   - 주최자 아킬레우스는 연민을 느끼며 군사들을 향해 "가장 훌륭한 자(ἄριστος ἀνήρ)가 말들을 꼴찌로 몰고 왔구나. 자, 마땅히(*epieikes*) 그에게 2등 상을 주도록 하자"(_Il._ 23.536–538)고 제안합니다. 이는 객관적 경기 결과 대신 에우멜로스의 공인된 신분적 아가토스 지위를 보상하려는 '설득적 정의(Persuasive justice)'의 시도였습니다.
2. **안틸로코스의 결과주의적 반발과 무력의 으름장**:
   - 2등으로 들어온 청년 안틸로코스는 자신의 합당한 몫인 암말을 빼앗기는 것에 강력히 반발합니다(_Il._ 23.543–554).
   - 안틸로코스는 "에우멜로스가 훌륭한 전사일지라도 불멸의 신들에게 기도했어야 했다"며 신적 불운조차도 전사 자신의 역량 부족으로 귀속시키고, 포상은 철저히 경기 결과(Results)에 따라 분배되어야 한다고 요구합니다.
   - 나아가 그는 "이 암말을 가져가려는 자는 누구든 나와 주먹으로 맞붙어야 할 것"이라며 물리적 전투력(Arete)에 의한 실력 행사를 불사하겠다고 위협합니다.
3. **애드킨스의 분석 귀결**:
   - 애드킨스는 이 사건이 호메로스 사회의 도덕적 한계를 극명히 드러낸다고 봅니다. 안틸로코스의 항의는 겉으로는 공정함([[concept-dike|Dike]])의 요구처럼 보이지만, 그 정당성의 최종 보증은 "덤비면 힘으로 꺾겠다"는 경쟁적 무력의 위협에 기대고 있습니다.
   - 결국 아킬레우스가 웃으며 자신의 사적 보물인 아스테로파이오스의 청동 흉갑을 에우멜로스에게 추가로 하사함으로써, 안틸로코스의 결과적 티메와 에우멜로스의 신분적 티메를 둘 다 보존하는 타협이 이루어집니다. 이는 호메로스 세계에서 협력적 정의가 경쟁적 가치의 절대적 권위를 훼손하지 않는 선에서만 타협적으로 성립할 수 있었음을 실증합니다.
