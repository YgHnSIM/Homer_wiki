...
| κύδιστε μέγιστε | *kúdiste mégiste* | 가장 영광스럽고 위대하신 분 | 호격 경칭 정형구 (동료들의 호칭) | _Il._ 2.412, 9.96, 19.78 |
...
1. **제1권: 명예의 충돌과 메니스의 촉발**
   ...
   - 법제사가 루이 제르네(1955)와 세르주 블레맹크([[vleminck-1982-institutional-aspect-of-time|1982]])가 규명했듯, 이는 군주가 공동체가 이미 공인하여 배당한 불변적 소유권(_Il._ 1.335)을 폭력적으로 침해한 군주의 **초과권력**(surdroit, ὕβρις) 행사였으며, 아킬레우스를 권리 없는 무자격 상태([[concept-time|아티미아]])로 전락시킨 제도적 범죄였다.
...
3. **제3권: 서약 제의와 봉건적 신종 조약 요구**
   - 파리스와 메넬라오스의 결투에 앞서 아가멤논은 양군 사이의 종전 맹약을 주재하며, 트로이아 측에 헬레네의 반환뿐만 아니라 아르고스 연합군과 총사령관 자신에게 "후대 인간들에게까지 영구히 남을 마땅한 티메를 바칠 것(*timēn apotinein*)"을 엄숙히 요구한다(_Il._ 3.284–290).
...
5. **제9권: 사절단 파견과 오만한 보상 조항**
   ...
   - 그러나 연설 말미에 "그는 내게 굴복할지어다. 내가 더 왕답고(*basileuteros*), 연배가 더 위이기 때문이다"라는 조건을 덧붙임으로써 사절단의 설득을 무위로 만든다(_Il._ 9.160–161). 애드킨스([[adkins-1960-merit-and-responsibility|Adkins 1960]])는 이 조건이야말로 아가멤논이 자신의 군주적 티메와 위계를 어떠한 물질적 양보 속에서도 결코 포기할 수 없었던 호메로스 경쟁적 가치 체계의 필연적 귀결이었음을 밝힌다.
...
#### 1) _Il._ 1.184–187 (브리세이스 강탈 선언: 군주적 초과권력 행사)
...
#### 2) _Il._ 2.101–107 (신성한 스켑트론 세습 계보: 왕권의 정통성)
...
#### 3) _Il._ 9.160–161 (사절단 말미 조건 선언: 위계적 티메의 고수)
...
#### 4) _Il._ 19.86–90 (화해 공론장의 아테 신화: 이중 동인론)
...
#### 5) _Od._ 11.411–415 (제1 네퀴아: 여물통 황소처럼 도살당한 죽음)
...
2. **제9권 사절단의 본질: 권력 위계의 재확인**:
   ...
   - 그는 보상 제안 말미에 "그는 내게 굴복할지어다. 내가 더 왕답고(*basileuteros*), 연배가 더 위이기 때문이다"(_Il._ 9.160–161)라고 천명했습니다.
