...
- **서사적 출현 범위**:
  - 『일리아스』: 작품의 발단인 1권 분노([[concept-menis|Menis]])의 촉발부터 9권 사절단 거부, 16권 파트로클로스의 출전과 전사, 18–22권 복수와 헥토르 사살, 23권 장례 경기 주재, 24권 프리아모스 탄원([[concept-hikesia|Hikesia]]) 수용 및 화해에 이르기까지 서사 전체의 내적 동력으로 기능합니다.
...
### 3.1 『일리아스』의 서사적 궤적
아킬레우스의 행적은 분노([[concept-menis|Menis]])에서 연민([[concept-eleos|Eleos]])으로 향하는 큰 정서적 흐름과, 그 흐름을 가로지르는 상실·폭력·장례의 전환점으로 읽혀 왔습니다. 아래 도식은 여러 연구와 호메로스 본문의 권별 사건을 종합한 문서 편집상의 서사 개요이며, 9권 거부와 24권의 의미에 관한 단일한 학설 판정은 아닙니다 ([[lee-junseok-2018-wrath-and-pity|이준석 2018]], [[shay-1994-achilles-in-vietnam|Shay 1994]], [[zanker-1994-heart-of-achilles|Zanker 1994]]).

```mermaid
flowchart TD
    A["1권: 메니스와 이탈"] --> B["9권: 사절단 거부·보상 위기"]
    B --> C["16–19권: 죽음·애도와 복귀"]
    C --> D["20–22권: 전투와 시신 능욕"]
    D --> E["23권: 장례와 경기"]
    E --> F["24권: 탄원 수용·시신 반환"]
```

1. **1권 (분노의 기원과 이중 동기화)**: 아가멤논이 아폴론 사제의 딸 크뤼세이스를 반환하는 대가로 아킬레우스의 전리품 브리세이스를 강탈하자, 최고 전사로서의 공적 명예([[concept-time|Timê]])가 짓밟힌 아킬레우스는 칼을 뽑아 아가멤논을 베려 합니다. 이때 아테나 여신이 나타나 머리채를 잡고 분노를 억제시킵니다 (_Il._ 1.188–222). 전선 이탈을 선언한 그는 어머니 테티스를 통해 제우스에게 아카이아군의 패배를 간청합니다 (_Il._ 1.350–412).
2. **9권 (사절단 거부와 보상 질서의 위기)**: 아카이아 진영이 붕괴 직전에 이르자 아가멤논은 막대한 배상물(Apoina)을 제시하며 오디세우스, 포이닉스, 아이아스로 구성된 사절단을 파견합니다. 그러나 아킬레우스는 목숨의 가치는 어떤 물질적 재화로도 바꿀 수 없음을 선언하며 제안을 전면 거부하고, 자신의 '두 가지 운명'을 공표합니다 (_Il._ 9.308–429). 이 거부의 도덕적·정치적 의미는 11절의 학술 논쟁처럼 해석이 갈립니다.
3. **16–19권 (파트로클로스의 죽음, 애도와 복귀)**: 함선이 불타는 위기 속에서 가장 가까운 전우 [[entity-patroklos|파트로클로스]]에게 자신의 갑옷을 입혀 출전을 허락하나, 그가 [[entity-hector|헥토르]]에게 전사하자 극한의 슬픔과 자책에 빠집니다 (_Il._ 16.843–854; 18.22–64). 테티스와 네레이스들이 함께 비탄하고, 헤파이토스가 제작한 새 신성 무구를 받은 뒤 (_Il._ 18.1–137), 아킬레우스는 19권에서 아가멤논과 화해하고 전장으로 돌아갈 준비를 갖춥니다 (_Il._ 19.1–237).
4. **20–22권 (아리스테이아와 헥토르 사살)**: 신에 필적하는 초인적 무용으로 트로이군을 학살하고, 강신(江神) 스카만드로스와 대적하며, 트로이의 수호 영웅 헥토르와 일대일 결투를 벌여 그를 사살합니다. 분노에 눈이 멀어 헥토르의 시신을 전차 뒤에 매달아 끌고 다니며 영웅적 규범([[concept-aidos|Aidos]])을 유린합니다 (_Il._ 22.395–404).
5. **23권 (파트로클로스의 장례와 경기)**: 아킬레우스는 파트로클로스의 장례를 주재하고 장례 경기를 열어 전우들을 위한 애도 의례를 조직합니다 (_Il._ 23.1–897).
6. **24권 (프리아모스의 탄원과 시신 반환)**: 야간에 목숨을 걸고 아들의 시신을 찾으러 온 적장 [[entity-priam|프리아모스]]의 탄원([[concept-hikesia|Hikesia]])을 받습니다. 아킬레우스는 프리아모스의 모습에서 고향에 홀로 남겨진 아버지 펠레우스를 떠올리고 함께 오열하며, 헥토르의 시신을 정중히 인도하고 12일간의 장례 휴전을 보장합니다 (_Il._ 24.477–676).
...
> [!NOTE] 전승 층위
> 『오뒷세이아』는 네오프톨레모스를 아킬레우스의 아들로 전하지만, 데이다메이아를 그의 모친으로 특정하는 계보는 호메로스 본문 밖의 후대 서사시환 전승에 속한다.

아킬레우스는 인간 국왕 [[entity-peleus|펠레우스]]와 네레이스(Nereis) 해신 [[entity-thetis|테티스]]의 아들로, 신적 혈통과 필멸의 운명을 함께 지닌 영웅입니다. 계보의 후대 전승은 10.1절 및 [[concept-epic-cycle|서사시환]]을 함께 참조하십시오.

### 4.2 인간 관계

| 대상 | 관계 및 서사 기능 | 원전 근거 |
|:---|:---|:---|
| [[entity-patroklos\|파트로클로스]] (Patroklos) | 가장 가까운 전우. 그의 출전과 전사는 아킬레우스의 애도와 전장 복귀의 직접 계기이다. | _Il._ 16.1–47, 16.843–854, 18.1–137 |
| 포이닉스(Phoinix) | 아버지 같은 연장자이자 9권 사절단의 설득자. | _Il._ 9.432–605 |
| [[entity-agamemnon\|아가멤논]] (Agamemnon) | 브리세이스와 [[concept-time\|Timê]]를 둘러싼 지휘권 갈등의 상대. 19권에서 공식 화해가 이루어진다. | _Il._ 1.121–187, 9.308–429, 19.1–237 |
| [[entity-hector\|헥토르]] (Hektor) | 결투와 살해의 상대. 시신 능욕은 24권의 반환 요청으로 이어진다. | _Il._ 22.131–404, 24.477–676 |
| [[entity-priam\|프리아모스]] (Priamos) | 탄원을 통해 헥토르의 시신을 요청하고, 아킬레우스에게서 반환과 12일 장례 휴전을 얻는다. | _Il._ 24.477–676 |
| [[entity-briseis\|브리세이스]] (Briseis) | 전쟁 포로. 브리세이스를 빼앗은 사건은 전리품(Geras)과 명예(Timê)를 둘러싼 갈등의 계기이며, 그는 19권에서 파트로클로스를 애도한다. | _Il._ 1.184–187, 19.282–300 |

### 4.3 신적 개입과 대결

| 존재 | 관계 및 서사 기능 | 원전 근거 |
|:---|:---|:---|
| [[entity-athena\|아테나]] (Athena) | 1권에서 아가멤논 살해를 제지하고, 22권 결투 국면에 개입한다. | _Il._ 1.188–222, 22.214–247 |
| [[entity-hephaestus\|헤파이토스]] (Hephaistos) | 테티스의 청에 따라 아킬레우스의 새 무구와 방패를 제작한다. | _Il._ 18.368–617 |
| [[entity-apollo\|아폴론]] (Apollon) | 트로이 편을 돕고 파트로클로스의 전사 및 아킬레우스의 추격 지연에 개입한다. | _Il._ 16.843–854, 21.595–611, 22.1–32 |
| 크산토스/스카만드로스 강신 (Xanthos/Skamandros) | 지형 자체가 아니라 의인화된 강신으로서 아킬레우스와 대결한다. | _Il._ 21.211–382 |
...
1. **불멸의 명성([[concept-kleos|Kleos Aphthiton]])의 길**: 트로이에 남아 싸우다 젊은 나이에 전사하지만, 영원히 칭송받는 명성을 얻는 길.
2. **평온한 귀환([[concept-nostos|Nostos]])의 길**: 고향 프티아로 돌아가 무명의 장수를 누리지만, 사후 영원히 잊혀지는 길.
...
호메로스 사회에서 전리품(*geras*)은 단순한 재산이 아니라 영웅의 탁월성([[concept-arete|Arete]])에 대해 공동체가 부여하는 공식적 가치 척도인 명예([[concept-time|Timê]])의 가시적 징표였습니다. 아가멤논의 브리세이스 강탈은 전사 사회의 합의된 배분 질서([[concept-themis|Themis]])를 파괴한 폭거였습니다.
...
### 8.2 탄원 의례([[concept-hikesia|Hikesia]])와 인간성의 회복
- 24권에서 프리아모스가 아킬레우스의 무릎을 잡고 아들을 죽인 원수의 손에 입 맞추는 장면은 호메로스 종교 의례 중 가장 극적인 탄원([[concept-hikesia|Hikesia]])입니다.
- 아킬레우스가 프리아모스를 일으켜 세우고 함께 식사를 나누는 행위는, 야수적 광기에서 벗어나 인간 문명의 거룩한 규범인 손님 환대([[concept-xenia|Xenia]])와 종교적 경외([[concept-aidos|Aidos]])로 복귀했음을 선포합니다.

---

## 9. 철학·윤리학적 해석 (Philosophical & Ethical Dimensions)

### 9.1 신적 분노([[concept-menis|Menis]]), 신체-정신 철학과 이중 동기화
- 아킬레우스의 분노(*mênis*)는 단순한 개인적 화(*cholos*)가 아니라 신들의 영역에 속하는 우주적 파괴력입니다.
- 호메로스 특유의 신체-정신 감정 좌소(座所, seat of emotion: 감정·충동·사고가 신체 내부에서 물리적으로 발생하고 머무는 자리)인 **튀모스([[concept-thumos|Thumos]])**와 **프렌([[concept-phren|Phren]])**의 관점에서 볼 때, 1권 188–222행에서 칼을 뽑으려는 내적 격정(*thumos*, 가슴속 뜨거운 혈기)을 아테나 여신이 머리채를 잡아 억제시키는 장면은 외적 신적 개입과 내적 심리 결단이 동시에 작동하는 전형적인 **'이중 동기화(Double Motivation)'**의 모델을 제시합니다 ([[dodds-1951-greeks-and-irrational|Dodds 1951]]).
- 정신의학자 조너선 셰이([[shay-1994-achilles-in-vietnam|Jonathan Shay 1994]])는 지휘관의 부당한 권력 남용([[concept-themis|Themis]]의 붕괴)으로 인해 전사가 겪는 심리적 파탄인 '도덕적 상해(Moral Injury)'의 관점에서 아킬레우스의 분노와 트라우마를 분석했습니다.

### 9.2 명예([[concept-time|Timê]])와 영예([[concept-kleos|Kleos]])의 분리
- 9권에서 아킬레우스는 영웅 사회 최초로 외적 보상 체계([[concept-time|Timê]])에 근본적 회의를 제기합니다.
...
### 9.3 연민([[concept-eleos|Eleos]])과 제우스의 두 항아리 우화
...
- 이 철학적 우화는 적과 동지라는 이분법을 넘어, **'모든 인간은 죽을 수밖에 없으며 고통받는 존재'**라는 유한한 인간 조건(*condicio humana*)에 대한 실존적 자각과 비극적 연민([[concept-eleos|Eleos]])으로 승화됩니다 ([[lee-junseok-2018-wrath-and-pity|이준석 2018]], [[zanker-1994-heart-of-achilles|Zanker 1994]]).

---

## 10. 후대 전승과 수용 (Post-Homeric Tradition & Reception)

### 10.1 서사시환 ([[concept-epic-cycle|Epic Cycle]])
  상세한 트로이 전쟁 8편 전편 구조 및 전승 체계는 서사시환(Epic Cycle) 문서를 참조하십시오.

- **『퀴프리아』(Cypria)**: 트로이 출정 전 스퀴로스섬 은신 전승, 후대 전승에서 데이다메이아와의 사이에 네오프톨레모스가 태어난 계보, 텔레포스의 상처 치유, 아울리스에서의 이피게네이아 제물 사건 등이 다루어집니다.
...
| 1·9·16–24권의 주요 전환점 | 호메로스 본문 | _Il._ 1권, 9권, 16–24권 | 원전 명시 | [[lee-junseok-2024-iliad-jeongam\|이준석 2024]] |
| 분노에서 연민으로의 3단계 동일화와 정서적 전개 | 현대 학술 연구 | 이준석 (2018), _Il._ 16.5, 23권, 24권 | 논쟁적 | [[lee-junseok-2018-wrath-and-pity\|이준석 2018]] |
| 24권 프리아모스 탄원 수용과 연민 | 호메로스 본문 | _Il._ 24.507–551 | 원전 명시 | [[zanker-1994-heart-of-achilles\|Zanker 1994]] |
| 데이다메이아를 네오프톨레모스의 모친으로 하는 계보 | 후대 문헌 | 『퀴프리아』 계열의 전승 요약 | 후대 수용 (고대 전승) | [[concept-epic-cycle\|서사시환]] |
...
- [[concept-phren|Phren]] — 사유와 감정이 교차하는 내적 기관
