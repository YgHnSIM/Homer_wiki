...
### 3.1 『일리아스』의 서사적 궤적
아킬레우스의 행적은 단순한 군사적 활약이 아니라, **분노([[concept-menis|Menis]]) → 탈인간화(야수화) → 비극적 자각 및 연민([[concept-eleos|Eleos]])**으로 이어지는 5단계 실존적 이행을 보여줍니다 ([[lee-junseok-2018-wrath-and-pity|이준석 2018]]):
...
3. **16–18권 (파트로클로스의 죽음과 죄책감)**: 함선이 불타는 위기 속에서 분신과도 같은 친구 [[entity-patroklos|파트로클로스]]에게 자신의 갑옷을 입혀 출전을 허락하나, 그가 [[entity-hector|헥토르]]에게 전사하자 극한의 슬픔과 자책에 빠집니다. 테티스와 네레이스들이 바다에서 올라와 함께 비탄의 애가를 부르고(_Il._ 18.22–64), 헤파이토스가 제작한 새 신성 무구를 받고 복수를 위해 전장에 복귀합니다 (_Il._ 18.1–137).
...
5. **23–24권 (화해와 연민의 서사시)**: 파트로클로스의 성대한 장례 경기를 주재한 뒤, 야간에 목숨을 걸고 아들의 시신을 찾으러 온 적장 [[entity-priam|프리아모스]]의 탄원([[concept-hikesia|Hikesia]])을 받습니다. 아킬레우스는 프리아모스의 모습에서 고향에 홀로 남겨진 아버지 펠레우스를 떠올리고 함께 오열하며, 헥토르의 시신을 정중히 인도하고 12일간의 장례 휴전을 보장합니다 (_Il._ 24.477–676).
...
> 상세한 트로이 전쟁 8편 전편 구조 및 전승 체계는 [[concept-epic-cycle|서사시환(Epic Cycle)]] 문서를 참조하십시오.
