...
- **서사적 궤적**: 사건·선택·결과·미해결 긴장을 3~5개 단락으로 연결하되, 원전이 말하지 않는 내면을 발명하지 않습니다.
- **인문학적 질문**: 장면에서 도출되는 질문을 3~4개 이내로 제시하고, 현대적 판결이나 단일한 정답으로 닫지 않습니다.
- **증거 층위 안내**: 원전 명시, 강한 학술 추론, 논쟁적 해석, 후대 수용을 구분하여 서사적 유창함이 확실성의 차이를 지우지 않게 합니다.
