...
```mermaid
graph TD
    A["호메로스 아이도스 (αἰδώς / aidṓs) 텍스트 전수 분석"] --> B["사전적·억제적 기능 (Prospective Emotion)<br/>비열하거나 불경한 행위를 저지르지 못하도록 막는 내적 양심"]
    A --> C["관계적·공감적 기능 (Other-regarding Emotion)<br/>약자, 탄원자, 손님에 대한 신성한 존중과 연민"]
    B & C --> D["네메시스 (Nemesis) 와의 상호작용<br/>사회적 도덕 비난을 예견하여 자신의 명예(Timê)를 지키는 자기존중"]
    D --> E["도즈(Dodds)의 피상적 '수치 문화' 테제 완전 극복"]
```
