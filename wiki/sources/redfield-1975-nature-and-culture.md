---
title: 일리아스의 자연과 문화 - 헥토르의 비극 (Nature and Culture in the Iliad, 1975)
...
key_concepts: ["[[Arete]]", "[[Timê]]", "[[Aidos]]", "[[Moira]]", "[[Themis]]"]
status: active
---
...
- **핵심 문제의식**:
  - 왜 영웅 사회는 공동체를 지키기 위해 영웅의 무력([[Arete]])을 필요로 하면서도, 그 영웅의 명예욕([[Timê]])에 의해 공동체 자체가 파멸하는 비극을 겪는가?
...
```mermaid
graph TD
    A["영웅 규범 (Heroic Code) 의 내적 모순<br/>무력(Arete)은 비사회적 폭력을 요구하나, 명예(Timê)는 사회적 인정을 요구함"] --> B["아킬레우스: 사회를 이탈하여 자연/야수로의 퇴행<br/>(식사 거부, 시신 훼손, 인간성 상실)"]
    A --> C["헥토르: 문화의 한가운데 선 시민적 영웅 (Aner Politikos)<br/>(가족과 조국을 지키려 하나 영웅적 Aidos 때문에 전사)"]
    B & C --> D["문화의 파탄과 오염 (Defilement)<br/>헥토르의 죽음과 트로이의 필연적 멸망"]
    D --> E["24권 장례식과 애도 의례 (Purification)<br/>야만적 폭력을 정화하고 인간 문화를 복원하며 서사시 종결"]
```
...
- 아레테([[Arete]])와 티메([[Timê]])의 긴장 관계를 분석합니다. 영웅은 자신의 목숨을 바쳐 공동체를 지키지만, 공동체가 자신의 명예를 조금이라도 훼손할 경우(1권의 갈등) 즉각 공동체를 파멸로 몰고 가는 위험한 존재입니다.

### 제3장: 헥토르의 비극 (*The Tragedy of Hector*)
- **시민적 영웅(Aner Politikos)의 딜레마**:
  - 헥토르는 아킬레우스와 달리 가족(안드로마케, 아스티아낙스)과 시민들의 평화를 사랑하는 문명인입니다.
  - 그러나 그는 동료들에 대한 부끄러움([[Aidos]])과 전사로서의 자존심 때문에 성벽 안으로 피신하라는 가족들의 애원을 뿌리치고 평원에서 홀로 싸우다 죽음을 맞이합니다.
...
| ***Il.* 22.99–130** | **성문 앞 헥토르의 고뇌** | 성안으로 들어가면 살 수 있으나 시민들의 비난([[Aidos]]) 때문에 성벽 밖에서 홀로 죽음을 맞는 헥토르의 시민적 딜레마. |
