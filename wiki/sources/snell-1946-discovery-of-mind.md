---
title: 정신의 발견 (Die Entdeckung des Geistes, 1946)
...
```mermaid
graph TD
    A["호메로스 어휘의 문헌학적 분석"] --> B["살아있는 신체 전체 (Soma) 어휘 부재<br/>신체는 사지(Melea)의 집합으로 지각됨"]
    A --> C["통합된 영혼 (Psyche) 어휘 부재<br/>Psyche는 사후 하데스로 가는 숨결일 뿐"]
    B & C --> D["기관 중심의 심리 모델 (Organ-based Psychology)<br/>Thymos, Noos, Phren 등 신체 장기 중심의 충동"]
    D --> E["외적 동기화 (External Motivation) 테제<br/>인간은 자율적 의지의 주체가 아니라 신의 개입에 의존"]
```
