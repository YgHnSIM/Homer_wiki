...
graph TD
    ...
    B --> C1["Aganos (기쁨 유발)<br/>얼굴을 밝히는<br/>온화한 말과 선물"]
    B --> C2["Meilichos (유화/완화)<br/>적대감을 해제하고<br/>긴장을 이완시키는 언행"]
    B --> C3["Kedos (소모/돌봄)<br/>안전망(Phila) 수호를 위한<br/>자원 소모 부담 감수"]
    B --> C4["Pistos (고정성/신뢰)<br/>예측 가능한 맹약과<br/>확고한 전우애의 결속"]
