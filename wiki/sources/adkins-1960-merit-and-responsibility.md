...
```mermaid
graph TD
    A["언어분석철학적 가치어 분석<br/>(칭찬어 Agathos / 비난어 Kakos 용례 전수 조사)"] --> B["2단계 가치 위계 발견<br/>경쟁적 가치 (Arete) >> 협력적 가치 (Dikaiosyne)"]
    B --> C["결과주의적 평가 모델<br/>'최선을 다했으나 패배했다'는 변명은 인정되지 않음"]
    C --> D["근대적 '도덕적 책임'의 부재<br/>의도(Intention)가 아니라 물리적 결과와 성공만이 평가의 척도"]
    D --> E["서사시 이후의 도덕사 전개<br/>비극과 플라톤을 거치며 협력적 가치가 Arete를 획득하는 과정"]
```
