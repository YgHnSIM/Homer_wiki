...
| 가치 범주 | 그리스어 실제형 | 학술 전사 | 핵심 희랍어 어휘 | 사회적 기능 및 의미 | 평가 기준 및 성격 |
|:---|:---|:---|:---|:---|:---|
| **경쟁적 가치** (Competitive Values) | ἀγαθός | *agathós* | **아가토스** (관용명 Agathos) | 군사적 용맹, 전투 승리, 부, 권력, 공동체 방어 역량 | **결과주의적 평가** (성공하면 도덕적 찬사, 실패하면 변명 없이 경멸) |
|  | ἀρετή | *aretḗ* | **아레테** (관용명 Aretē) | 전사적 탁월성과 전투 수행 능력 | **결과주의적 평가** (성공하면 도덕적 찬사, 실패하면 변명 없이 경멸) |
|  | τιμή | *timḗ* | **티메** (관용명 Timê) | 전리품과 지위로 가시화되는 명예와 사회적 몫 | **결과주의적 평가** (성공하면 도덕적 찬사, 실패하면 변명 없이 경멸) |
| **협력적/정적 가치** (Cooperative Values) | δικαιοσύνη | *dikaiosúnē* | **디카이오시네** (관용명 Dikaiosyne) | 공정함과 관습적 몫의 준수 | **2차적/종속적 가치** (경쟁적 가치와 충돌할 때 언제나 후순위로 밀림) |
|  | σωφροσύνη | *sōphrosúnē* | **소프로시네** (관용명 Sophrosyne) | 절제와 자기 통제 | **2차적/종속적 가치** (경쟁적 가치와 충돌할 때 언제나 후순위로 밀림) |
|  | αἰδώς | *aidṓs* | **아이도스** (관용명 Aidos) | 타인 존중, 평화 유지, 계약 준수 | **2차적/종속적 가치** (경쟁적 가치와 충돌할 때 언제나 후순위로 밀림) |
...
- **아가토스(ἀγαθός, *agathós*)와 아레테(ἀρετή, *aretḗ*)의 본질**:
  - 'agathos'는 현대어의 '착한(good)'이 아니라, '전쟁에서 승리할 수 있는 유능함, 용기, 부, 가문'을 뜻합니다.
  - 전장에서 패배한 자는 "의도는 좋았다"거나 "최선을 다했다"고 변명할 수 없습니다. 패배는 곧 무능이며, 그는 즉각 비난어인 ‘**카코스(κακός, *kakós*; 나쁜/비천한 자)**’로 낙인찍힙니다.
- **아이스크론(Aischron)과 수치**:
