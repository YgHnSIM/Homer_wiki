...
citations_count: 980+
key_concepts: ["[[Dike]]", "[[Themis]]", "[[Xenia]]", "[[Moira]]", "[[Ate]]"]
status: active
---
...
|:---|:---|:---|
| **『일리아스』의 정의** | 정의([[Dike]]) 개념 부재, 전사의 무력과 명예만 존재 | **트로이 멸망의 전 과정이 파리스의 불의에 대한 제우스의 응징** |
| **신들의 도덕성** | 신들은 인간의 도덕에 무관심하며 변덕스럽게 행동함 | 제우스는 우주적 균형과 맹세, 환대([[Xenia]])를 수호하는 정의의 주관자 |
...
```mermaid
graph TD
    A["'일리아스에는 정의가 없다'는 발전론 비판"] --> B["트로이 전쟁의 종교-도덕적 기원 규명<br/>(파리스의 Xenia 침범에 대한 제우스 크세니오스의 심판)"]
    B --> C["일리아스 본문 속 정의의 텍스트 증거<br/>(*Il.* 16권 제우스의 폭우 비유: 굽은 판결에 대한 신벌)"]
    C --> D["디케 (Dikē) 와 모이라 (Moira) 의 통합<br/>인간의 오만(Hybris)은 반드시 신벌(Tisis)을 부름"]
    D --> E["서사시에서 비극으로 이어지는 그리스 종교-윤리 사상의 일관성 확립"]
```
...
### 제1장: 호메로스의 정의 (*Homer*)
1. **트로이아 전쟁의 도덕적 원인**:
   - 트로이의 함락은 단순한 군사적 정복이 아닙니다. 파리스가 메넬라오스의 환대([[Xenia]])를 배신하고 헬레네를 납치한 불경죄에 대해, 환대의 수호신 **제우스 크세니오스(Zeus Xenios)**가 내리는 필연적인 종교적 심판입니다.
2. **『일리아스』 16권의 결정적 증거**:
...
| ***Il.* 16.384–393** | **제우스의 폭우 비유** | 부정한 판결로 정의([[Dike]])를 왜곡한 인간들에게 제우스가 분노하여 홍수를 내린다는 구절. 『일리아스』의 신들이 도덕과 직결되어 있음을 보여주는 결정적 증거. |
