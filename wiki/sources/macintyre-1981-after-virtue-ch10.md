---
title: 덕의 상실 - 제10장 영웅 사회에서의 덕들 (After Virtue, Ch. 10, 1981)
...
```mermaid
graph TD
    A["근대 도덕 기획의 붕괴 진단<br/>(공동체로부터 분리된 추상적 자아의 한계)"] --> B["호메로스 영웅 사회의 덕 분석<br/>(인간은 사회적 역할 속에서만 정체성을 가짐)"]
    B --> C["역할에 정초된 덕 (Role-constituted Virtues)<br/>'A man is what he does' - 존재와 당위의 통일"]
    C --> D["삶의 서사적 통일성 (Narrative Unity)<br/>덕과 삶의 의미는 공동체 이야기(전설, 서사시) 속에서 완결"]
    D --> E["현대 덕 윤리학 (Virtue Ethics) 의 부흥<br/>아리스토텔레스와 호메로스로의 회귀 촉구"]
```
