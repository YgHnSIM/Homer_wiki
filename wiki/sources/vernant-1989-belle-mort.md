---
title: 아름다운 죽음과 호메로스 영웅 윤리 (La belle mort et le cadavre outragé, 1989)
...
```mermaid
graph TD
    A["인간의 필멸성 (Mortality) 의 딜레마<br/>(노화와 죽음은 육체의 아름다움과 기억을 파괴함)"] --> B["영웅적 선택: 전장에서의 장렬한 전사<br/>(젊음의 절정에서 맞이하는 '아름다운 죽음')"]
    B --> C["시적 기념 (Mnemosyne) 과 불멸의 명예 (Kleos)<br/>시인의 노래 속에서 영원히 젊고 찬란한 존재로 남음"]
    C --> D["시신 훼손 (Outrage du cadavre) 의 금기<br/>시신이 훼손되면 영웅적 기억과 정체성 자체가 파괴됨"]
    D --> E["24권 헥토르 시신 수습과 장례식의 윤리적 필연성"]
```
