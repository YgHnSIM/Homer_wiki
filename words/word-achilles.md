...
> **요약**: 호메로스 서사시 『일리아스』의 주인공 영웅 [[entity-achilles|아킬레우스]](Ἀχιλλεύς)의 이름에서 유래한 인명 유래어(Eponym)로, 고대 그리스어 시학의 "군대에게 비탄을 가져오는 자"(_Achi-lāwos_)에서 출발하여 라틴어와 중세 프랑스어를 거쳐 현대 영어의 고유명사, 문학적 형용사(_Achillean_), 해부학 전문어(_Achilles tendon_), 식물학 속명(_Achillea_), 그리고 치명적 취약점을 뜻하는 핵심 관용구(_Achilles' heel_)로 정착 및 다각화되었습니다.
...
- **호메로스 위키 연관 엔티티 및 개념 문서**:
  ...
  - [[concept-hikesia|히케시아 (Hikesia / ἱ케시아)]] — 프리아모스의 거룩한 탄원 의례
