---
title: Polytropos (폴리트로포스)
word: Polytropos
korean_name: 폴리트로포스
conventional_latin: Polytropos
greek: "πολύτροπος"
transliteration: "polútropos"
transliteration_system: homeric-oriented-v1
cssclasses: [greek-reading-page]
greek_root: "πολύτροπος (polútropos; 형용사; πολύς + τροπ-/τροπο-; τρόπος·τροπή·τρέπω와 관련)"
pie_root: "Uncertain / Pending"
word_type: concept
transmissions: [greek, modern_english]
aliases: ["Polytropos (폴리트로포스 / πολύτροπος)", "Polytropos (πολύτροπος / 폴리트로포스)", "Polytropos (폴리트로포스)", πολύτροπος, πολύτροπον, polytropos, polutropos, polýtropos, polútropos, Polytropos, 폴리트로포스, 폴뤼트로포스]
tags: [type/word, domain/etymology, domain/odyssey, status/review]
created: 2026-08-26
updated: 2026-08-26
sources:
  - "Liddell–Scott–Jones, πολύτροπος·τρόπος·τροπή·τρέπω"
  - "Cunliffe, A Lexicon of the Homeric Dialect, πολύτροπος"
  - "Homer, Odyssey 1.1; 10.330"
  - "wiki/analyses/analysis-polytropos.md"
  - "words/word-odyssey.md"
status: review
---
...
graph TD
    ...
    MID["라틴어·고대 프랑스어·중세 영어<br/>중간 단계"] -. "독립 증거 확보 전 보류" .-> ENG
    ODY["Ὀδύσσεια / Odysseia<br/>작품명"] -. "별도 평행 계통" .-> LAT["Latin Odyssea"]
    LAT -. "별도 평행 계통" .-> FR["French odyssée"]
    LAT -. "별도 평행 계통" .-> ODYENG["English Odyssey / odyssey"]
    NAME["Ὀδυσσεύς<br/>오디세우스 이름"] -. "별도 인명 계통" .-> ULI["Latin Ulixes / Ulysses"]
```

이 도식에서 실선은 고대 그리스어 표제형과 검증된 호메로스 굴절형의 관계를 나타낸다. 현대 영어 가지는 학술적 음역·사용 층위로 제한하며, `πολύτροπος`가 라틴어·프랑스어·중세 영어를 순차적으로 거친 상속어라는 뜻으로 읽어서는 안 된다. `Odyssey`, `odyssée`, `Ulixes/Ulysses`는 오디세우스 이름과 작품명의 별도 계통이므로 이 표제어의 직접 파생어로 세지 않는다.
