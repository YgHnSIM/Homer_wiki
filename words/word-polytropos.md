...
aliases: [πολύτροπος, πολύτροπον, polytropos, polutropos, Polytropos, 폴리트로포스, 폴뤼트로포스]
...
```mermaid
graph TD
    GRK["고대 그리스어 πολύτροπος<br/>polýtropos<br/>πολυ- + τροπ-/τροπο-"] --> H1["호메로스 굴절형 πολύτροπον<br/>Od. 1.1"]
...
|:---|:---|:---|
| `πολυ-` | `πολύς`와 연결되는 복합어 요소. “많은, 여러”의 의미를 제공함 | 정설·문헌 입증 |
| `τροπ-/τροπο-` | `τρόπος`의 방식·방향·성격, `τροπή`의 전환, `τρέπω`의 돌림·방향 전환과 연결되는 어휘군 | 정설·문헌 입증 |
| `πολύτροπος` 전체 | “여러 방식으로 전환된/전환하는” 의미 영역을 여는 복합 형용사 | 문헌 입증 및 해석적 세분화 |
| `μορφή` | “형태·형상”을 뜻하는 별개의 여성 명사. `πολύτροπος`의 구성 요소나 중간 어형이 아님 | 정설·문헌 입증 |
...
- `ἄνδρα μοι ἔννεπε, μοῦσα, πολύτροπον` — _Od._ 1.1.
- `ὃς μάλα πολλὰ πλάγχθη` — _Od._ 1.2.
...
- `ἦ σύ γʼ Ὀδυσσεύς ἐσσι πολύτροπος` — _Od._ 10.330.
...
`πολύτροπος` 계열은 호메로스의 시적 수식어에 머물지 않고 후대 문헌에서 “여러 방식으로”, “변통성 있는”, “교활한”, “다양한” 방향으로 의미가 확장된다. LSJ는 호메로스 용례와 고전기·후대 용례를 구분해 제시하며, 투퀴디데스의 `πολυτρόποις`, `τὸ πολύτροπον τῆς γνώμης`, 히브리서 1.1의 `πολυτρόπως`를 의미 확장의 사례로 묶는다.
