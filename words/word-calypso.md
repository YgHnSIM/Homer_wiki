...
greek_root: "καλύπτω (kalúptō; 동사: 덮다, 가리다, 숨기다) / Καλυψώ (Kalupsṓ; 고유명사: 은폐자)"
pie_root: "*ḱel-"
word_type: eponym
...
tags: [type/word, domain/etymology, domain/odyssey, status/active]
created: 2026-09-03
updated: 2026-09-03
sources: [Beekes 2010, Chantraine DELG, Pokorny IEW, OED, Peradotto 1990, LSJ]
status: active
---
...
- **고유명 형성 접미사**: 고유명 **Καλυψώ**(*Kalupsṓ*)는 고졸기 그리스어 인명학에서 널리 쓰이던 여성 접미사 `-ώ`(*-ṓ*)가 결합한 능동적 여성 행위자 명사(*nomen agentis*)입니다. 이는 수동적으로 '숨겨진 여인'이 아니라 대상을 적극적으로 '덮어 가리는 능동적 은폐자(The Concealer)'를 의미합니다(Peradotto 1990).
- **동원 명사군**:
...
| **Καλυψώ** | *Kalupsṓ* | 고유명 여성 주격 단수 (행위자 명사) | 감추는 여인, 은폐자 | _Od._ 1.14; Chantraine DELG 488 |
...
- 『오뒷세이아』 7권 245행: 오뒷세우스의 1인칭 회고 한정 형용사 결합(*Átlantos thugátēr, dolóessa Kalupsṓ*).
...
### 5.1 음운 및 철자 변천
- **희랍어 단계**: `Καλυψώ` (*Kalupsṓ*, 무성 양순파열음 p + 무성 치경마찰음 s의 이중자음 ψ 및 장모음 ō 보존).
...
2. **서사적 인격화**: "영웅을 세상의 빛과 명성으로부터 격리하여 숨겨두는 외딴 섬의 요정" (호메로스 *Kalupsṓ*).
