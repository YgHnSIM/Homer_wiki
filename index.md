...
호메로스 서사시(*일리아스*, *오뒷세이아*)와 고대 그리스 영웅 윤리, 문헌학, 어원 수용사를 모은 상호 연결형 지식 베이스입니다. 아래 링크는 실제로 작성된 문서만 가리킵니다.
...
- [[analysis-concept-source-matrix|개념과 문헌]] — 핵심 개념 9종과 학술 문헌 24종의 맞물림 매트릭스
...
- 전체 24종 소스 문헌 목록 및 상세 해제는 [[wiki/index#소스 문서|위키 색인 (소스 문서)]]에서 확인할 수 있습니다.
...
- 검색: 한국어, 영어, 희랍어 표제어
- 리더 모드: 긴 항목에서 본문만 남김
- 목차와 역링크: 우측 패널에서 현재 문서의 구조와 연결된 문서를 확인할 수 있습니다.
- 그리스어 읽기: [[greek-reading-guide|표기 안내]]에서 원어·학술 전사·긴 인용 규칙을 확인할 수 있습니다.
